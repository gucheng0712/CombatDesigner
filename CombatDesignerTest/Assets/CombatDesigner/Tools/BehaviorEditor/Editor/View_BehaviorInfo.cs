...
public class View_BehaviorInfo
{
    ...
    {
        if (BehaviorEditorWindow.selectedBehavior == null || BehaviorEditorWindow.selectedBehavior.behaviorActions == null)
        {
            return;
        }
        actionScrollPos = GUILayout.BeginScrollView(actionScrollPos);

        if (BehaviorEditorWindow.selectedBehavior.behaviorActions.Count > 0)
        {
    ...
    {
        if (BehaviorEditorWindow.selectedBehavior == null || BehaviorEditorWindow.selectedBehavior.attackInfos == null)
        {
            return;
        }
        actionScrollPos = GUILayout.BeginScrollView(actionScrollPos);
