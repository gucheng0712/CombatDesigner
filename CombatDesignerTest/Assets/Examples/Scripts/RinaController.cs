...
{
    public class RinaController : ActorController
    {
        #region Fields
        /// <summary>
        ...
        /// <summary>
        /// Updating the Player control logics
        ...
        /// <summary>
        /// A method to detect the target object. 
        /// </summary>
        void TargetDetection()
        {
            if (model.target != null)
            {
                if (Vector3.Dot(model.character.transform.forward, model.target.transform.position) < 0)
                {
                    model.hasLockdeTarget = false;
                    model.target = null;
                }
                else
                {
