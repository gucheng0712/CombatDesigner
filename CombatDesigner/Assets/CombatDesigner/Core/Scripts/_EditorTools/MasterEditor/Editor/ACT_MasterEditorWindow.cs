...
//        [MenuItem("CombatDesigner/Master Editor")]
//        static void Open()
//        {
...
//            //tree.AddAllAssetsAtPath("Actor Models", "Assets", typeof(ActorModel), true, true);
//            tree.AddAllAssetsAtPath("Actor Behaviors", "Assets", typeof(ActorBehavior), true, true).ForEach(this.AddDragHandles);
